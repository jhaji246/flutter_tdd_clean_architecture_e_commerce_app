...
import 'package:flutter_tdd_clean_architecture_e_commerce_app/domain/repositories/delivery_info_repository.dart';
import 'package:flutter_tdd_clean_architecture_e_commerce_app/domain/usecases/delivery_info/get_cached_delivery_info_usecase.dart';
...
void main() {
  ...
  setUp(() {
    ...
    usecase = GetCachedDeliveryInfoUseCase(
        mockProductRepository as DeliveryInfoRepository);
  });
