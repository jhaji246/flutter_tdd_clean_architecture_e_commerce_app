...
import 'package:flutter_tdd_clean_architecture_e_commerce_app/domain/repositories/category_repository.dart';
...
void main() {
  ...
  setUp(() {
    ...
    usecase =
        GetCachedCategoryUseCase(mockProductRepository as CategoryRepository);
  });
